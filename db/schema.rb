...
ActiveRecord::Schema.define(version: 2022_07_07_095902) do
  ...
  create_table "purchase_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id_id"], name: "index_purchase_records_on_item_id_id"
    t.index ["user_id_id"], name: "index_purchase_records_on_user_id_id"
  end
